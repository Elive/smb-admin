...
setup(name = "smb-admin",
	version = "1.08.03",
	description = "This program was designed to assist users in managing samba settings, shares and users. Its purpose is to be simple yet allow the user plenty of options. For a more powerful samba admin program, look at gsamabd or SWAT.",
	author = "David Braker",
